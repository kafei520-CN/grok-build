...
export const EN = {
  ...
  themeSurface: 'Panel',
  themeSurfaceHint: 'Frosted glass is the main chat plate. Settings and drawers blur home and chat behind them.',
...
export const ZH: Record<StringKey, string> = {
  ...
  themeSurface: '面板',
  themeSurfaceHint: '毛玻璃用在主页和对话上。打开设置、抽屉时会模糊背后的主界面，主页本身不会当成下级菜单。',
  themeSurfaceFlat: '默认',
