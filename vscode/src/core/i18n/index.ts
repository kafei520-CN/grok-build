...
export const EN = {
  ...
  settingsRemoteTunnelErrKeyFile:
    'The tunnel key could not be used. Install OpenSSH (Windows optional feature) and turn public access off then on.',
  ...
  settingsRemoteRelayHint:
    'Official needs no key. Custom: IP plus the hostKey from that Grok Web server. The share URL uses the IP you enter here.',
  settingsRemoteRelayOfficial: 'Official server',
  settingsRemoteRelayCustom: 'Custom server',
  settingsRemoteRelayKey: 'Relay key',
  settingsRemoteRelayKeyHint: 'Copied from the Grok Web control panel. Official servers do not need this.',
...
export const ZH: Record<StringKey, string> = {
  ...
  settingsRemoteTunnelErrKeyFile:
    '隧道密钥无法使用。请安装 OpenSSH（Windows 可选功能），然后关掉再打开公网。',
  ...
  settingsRemoteRelayHint:
    '官方不用密钥。自定义只填 IP 和控制面板里的中转密钥。发给对方的地址会用你填的 IP，不必改服务端公网主机。',
  settingsRemoteRelayOfficial: '官方服务器',
  settingsRemoteRelayCustom: '自定义服务器',
  settingsRemoteRelayKey: '中转密钥',
  settingsRemoteRelayKeyHint: '从 Grok Web 控制面板复制。官方服务器不需要填写。',
